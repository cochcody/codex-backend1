...
def stripe_webhook():
    ...
    if event["type"] == "checkout.session.completed":
        ...
        try:
            ...
            # retrieve payment intent to read application_fee_amount
...
def admin_approve():
    ...
    # find the developer who uploaded the game
    ...
    # get developer's Stripe account ID (may be None if not connected yet)
    ...
    games["games"].append({
        ...
        "price": upload["price"],
        "developer_email": dev_email,
        "developer_stripe_account": dev_stripe,  # ⭐ IMPORTANT FOR PAYOUTS
...
def admin_analytics():
    ...
    total_sales = len(purchases.get("purchases", []))  # or len(payouts["payouts"])
