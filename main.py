...
# You don't have this yet — leave it blank in Render until Stripe approves Connect
STRIPE_CONNECT_CLIENT_ID = os.getenv("STRIPE_CONNECT_CLIENT_ID")

# Your webhook secret stays hardcoded (this is normal)
...
@app.put("/api/admin/store/update/<game_id>")
@require_admin
def admin_update_game(game_id):
    ...
    game = next((g for g in game_list if g.get("id") == game_id), None)
    if not game:
